...
//extern char file_name[100];  //文件名
//extern FIL  fnew;   //文件指针
//extern UINT fnum;  //传输内容数量
...
void DEBUG_USART_IRQHandler(void)
{
  //  uint16_t t;
	...
	//	ILI9341_DispString_EN_CH(70,70,(char *)ReceiveBuff);
	 USARTx_ReceiveFile();
...
//		 
//		DMA_SetCurrDataCounter(USART_TX_DMA_CHANNEL, SENDBUFF_SIZE);
